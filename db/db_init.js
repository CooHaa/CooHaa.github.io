...
// Insert sample data
db.execute(insert_sample_tasks, ['1', 'Math Homework', '2', '3', '20', '2', 'Chapter 13.4 is due tomorrow!']);
db.execute(insert_sample_tasks, ['2', 'World Domination', '1', '1', '20', '3', 'Maybe some day.']);
db.execute(insert_sample_tasks, ['3', 'Sleep', '1', '3', '8', '2', 'I need to sleep more! I haven\'t been getting good sleep because of my procrastination.']);
db.execute(insert_sample_tasks, ['4', 'Study for Math Quiz', '2', '2', '2', '2', 'I have a quiz on triple integrals next week. I should get on that!']);
db.execute(insert_sample_tasks, ['5', 'Become God', '3', '1', '100', '3', 'Eventually...']);
